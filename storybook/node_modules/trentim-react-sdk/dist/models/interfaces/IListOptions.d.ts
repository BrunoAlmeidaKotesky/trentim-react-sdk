...
import type { IGridClickActions, IRow } from '../interfaces/IGridView';
...
export declare type IConfigurableHeader<T = any> = Omit<IListOptionsProps<T>, 'onSearchItemChange' | 'onClickSearchIcon' | 'setIsFilterPanelOpen' | 'setGroupBy' | 'setIsGroupPanelOpen' | 'onFilterIconClick' | 'onSearchBoxClick' | 'onGroupIconClick' | 'onGroupPanelCancel' | 'onFilterPanelCancel'>;
