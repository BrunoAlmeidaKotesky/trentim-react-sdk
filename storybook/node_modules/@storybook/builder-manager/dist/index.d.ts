...
declare type Addon_IndexEntryLegacy = [StoryId, any, Parameters$2, Parameters$2];
...
interface Parameters$2 extends Parameters$1 {
    fileName?: string;
...
declare type ManagerBuilder = Builder<Builder_WithRequiredProperty<BuildOptions, 'outdir'> & {
    entryPoints: string[];
}, BuilderStats>;
...
declare const start: (options: BuilderStartOptions) => Promise<void | {
    stats?: lib_types_dist.BuilderStats | undefined;
    totalTime: [number, number];
    bail: (e?: Error | undefined) => Promise<void>;
}>;
declare const build: (options: BuilderStartOptions) => Promise<void | lib_types_dist.BuilderStats>;
