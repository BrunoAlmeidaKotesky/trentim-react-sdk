...
var r = class {
  constructor({ transport: e, async: t = false } = {}) {
    this.sender = a();
    this.events = {};
    this.data = {};
    this.isAsync = t, e && (this.transport = e, this.transport.setHandler((n) => this.handleEvent(n)));
  }
  get hasTransport() {
  ...
  emit(e, ...t) {
    let n = { type: e, args: t, from: this.sender }, s = {};
    t.length >= 1 && t[0] && t[0].options && (s = t[0].options);
    let i = () => {
      this.transport && this.transport.send(n, s), this.handleEvent(n);
    };
  ...
  removeListener(e, t) {
    ...
    n && (this.events[e] = n.filter((s) => s !== t));
  }
  on(e, t) {
  ...
  onceListener(e, t) {
    let n = (...s) => (this.removeListener(e, n), t(...s));
    return n;
  }
};
...
//# sourceMappingURL=chunk-EF2YLWYO.js.map
