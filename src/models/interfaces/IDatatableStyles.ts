...
export interface IBodyStyles {
    ...
    tableBodyRow: {style?: CSSProperties, specficRow?: {positions: number[], style: CSSProperties}};
    tableCell: {style?: CSSProperties, specificCells?: {keys: string[], style: CSSProperties, positions?: number[]}};
}
