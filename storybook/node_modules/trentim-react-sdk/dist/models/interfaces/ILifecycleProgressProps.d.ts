...
export declare type LifecycleCallout = {
    isVisible: boolean;
    calloutIdx: number;
};
export declare type ILifecycleProgressRef = {
...
export declare type OnStagClick<D> = (currentStage: ILifecycleStages<D>, curIndex: number, setCallout?: Dispatch<SetStateAction<LifecycleCallout>>, event?: React.MouseEvent<HTMLDivElement, MouseEvent>) => void;
