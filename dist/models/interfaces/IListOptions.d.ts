...
export declare type IConfigurableHeader<T = any> = Omit<IListOptionsProps<T>, 'onSearchItemChange' | 'onClickSearchIcon' | 'setIsFilterPanelOpen' | 'setRenderAs' | 'setGroupBy' | 'setIsGroupPanelOpen' | 'onFilterIconClick' | 'onSearchBoxClick' | 'onGroupIconClick' | 'onGroupPanelCancel' | 'onFilterPanelCancel'>;
