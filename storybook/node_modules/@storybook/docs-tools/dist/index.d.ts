...
import { StrictArgTypes, AnyFramework, StoryContextForEnhancers, Options } from '@storybook/types';
...
declare type PropsExtractor = (component: Component) => {
    rows?: PropDef[];
} | null;
declare type ArgTypesExtractor = (component: Component) => StrictArgTypes | null;
...
declare type ParseJsDoc = (value?: string, options?: JsDocParsingOptions) => JsDocParsingResult;
...
declare type ExtractProps = (component: Component, section: string) => ExtractedProp[];
...
declare const enhanceArgTypes: <TFramework extends AnyFramework>(context: StoryContextForEnhancers<TFramework, _storybook_types.Args>) => _storybook_types.StrictArgTypes<_storybook_types.Args>;
