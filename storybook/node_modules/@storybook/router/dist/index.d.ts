import { StoryData } from './utils.js';
export { DEEPLY_EQUAL, StoryData, buildArgsParam, deepDiff, getMatch, parsePath, queryFromLocation, queryFromString, stringifyQuery } from './utils.js';
...
interface NavigateFunction {
    (to: To, options?: NavigateOptions$1): void;
    (delta: number): void;
}
 ...
 */
declare function useNavigate$1(): NavigateFunction;
...
declare type NavigateOptions = ReturnType<typeof useNavigate$1> & {
    plain?: boolean;
};
...
export { BaseLocationProvider, Link, LinkProps, Location, LocationProvider, Match, NavigateOptions, RenderData, Route, RouterData, useNavigate };
