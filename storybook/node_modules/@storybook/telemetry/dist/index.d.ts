...
declare type Options$2 = LoadOptions & StorybookConfigOptions & CLIOptions & BuilderOptions;
...
interface StorybookConfig {
     ...
     */
    refs?: CoreCommon_StorybookRefs | ((config: any, options: Options$2) => CoreCommon_StorybookRefs);
    /**
     ...
     */
    config?: (entries: Entry[], options: Options$2) => Entry[];
    /**
     * Add additional scripts to run in the preview a la `.storybook/preview.js`
     */
    previewAnnotations?: (entries: Entry[], options: Options$2) => Entry[];
    /**
     ...
     */
    previewHead?: (head: string, options: Options$2) => string;
    previewBody?: (body: string, options: Options$2) => string;
}
...
declare type EventType = 'boot' | 'dev' | 'build' | 'upgrade' | 'init' | 'error' | 'error-metadata';
